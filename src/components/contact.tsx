...
interface ImageClipBocProps {
    src: string
    alt: string
    clipClass: string
}

const ImageClipBox = ({src, clipClass, alt}: ImageClipBocProps) => {
    return (
            ...
            <div className={'relative rounded-lg bg-black py-24 text-blue-50 sm:overflow-hidden'}>
                ...
                <div className={'flex flex-col items-center text-center'}>
                    ...
                    <Button
                        id={''}
                        title={'Contact Us'}
                        containerClass={'mt-10 cursor-pointer hover:bg-yellow-300 transition-all duration-300'}
                    />
                </div>
            </div>
        </div>
